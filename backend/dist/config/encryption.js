 ...
 */
export function encryptConfig(data, masterKey) {
 ...
 */
export function decryptConfig(encryptedData, masterKey) {
 ...
 */
export function decryptConfigJson(encryptedData, masterKey) {
